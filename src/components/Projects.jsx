            ...
            <article className="flex h-full flex-col gap-4 rounded-xl border border-neutral-900/10 bg-neutral-900/5 p-6 transition hover:border-rust/40">
              ...
              {project.role && (
                <p className="text-sm text-neutral-500">
                  <span className="font-medium text-neutral-700">My role: </span>
                  {project.role}
                </p>
              )}
                  ...
                  <div className="flex gap-4">
                    {project.repoUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 rounded text-neutral-700 hover:text-rust focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rust"
                      >
                    ...
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="live-link inline-block rounded font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rust"
                      >
                        Live
                      </a>
                    )}
